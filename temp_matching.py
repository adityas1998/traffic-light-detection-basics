...
def main(argv):
    ...
    if (len(sys.argv) < 3):
        ...
        print ('Usage:\nmtemplate_matching.py <image_name> <template_name> [<mask_name>]')
        return -1
    ...
    # cv.setWindowProperty(image_window, cv.WND_PROP_FULLSCREEN, cv.WINDOW_FULLSCREEN)
    cv.namedWindow( result_window, cv.WINDOW_AUTOSIZE )
    # cv.setWindowProperty(result_window, cv.WND_PROP_FULLSCREEN, cv.WINDOW_FULLSCREEN)
    ## [create_windows]
